...
1. Go to Spaces > Manage keys >  Generate new key and secret > Copy it into .env.example (note: the endpoint shoul be like this: https://fra1.digitaloceanspaces.com/ not the full one)
